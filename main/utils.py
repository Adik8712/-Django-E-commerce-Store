...
def valid_price(price):
    if int(price) <= 0:
        raise ValidationError('Цена не может быть отрицательной или равноверной нулю')
    
    if not price.isdigit():
        raise ValidationError('Цена должна быть числома')
...
#     sender = "endless.key.2018@gmail.com"
#     user = input("Введите Email получвтеля: ")
...
#         msg["Subject"] = "Нажми на меня"
#         server.sendmail(sender, user, msg.as_string())
        
#         return "Сообщение успешно отправлено"
    
#     except Exception as _ex:
#         return f"{_ex}, Не получилось отправить сообщение"
